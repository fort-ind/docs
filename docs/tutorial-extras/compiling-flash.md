...
1A. Copy the link (for example [theworldshardestgame.swf](https://github.com/StrangerKO/theworldshardestgame.swf/blob/main/theworldshardestgame.swf)).

2A. If the file is over 20mb, go to [https://raw.githack.com](https://raw.githack.com/), paste the GitHub URL there, then go to [https://cdn.jsdelivr.net/github/](https://cdn.jsdelivr.net/github/).

3A. Paste the link and copy the converted link (should look like [cdn.jsdelivr link](https://cdn.jsdelivr.net/gh/StrangerKO/theworldshardestgame.swf@main/theworldshardestgame.swf)).

4A. Go to [flashgame.html template](https://github.com/genizy/sgdsgd/blob/main/flashgame.html) and copy the code, then replace the PUT THE URL HERE part with the URL that was generated.
